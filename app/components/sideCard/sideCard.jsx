...
function SideCard() {
  return (
    <div className=" h-auto w-84 pl-2 ">
...

{
    ...
    <div key={id} className="flex gap-4 w-full my-2 bg-white   hover:bg-customWhite transition-all
    shadow-lg hover:shadow-none   duration-500 p-3  ">
      <Image
        src={details[1].img}
        width={135}
        height={60}
    ...
    {details[1].title}
        ...
        <h1 className=" pb-2 text-xs  ">
          ...
          <span className="font-bold tracking-wide">YdKurt</span> {details[1].date}
          <Link href={`/categories/${category}/${details[1].title}`}>
             <AiOutlineArrowRight className='pt-1 text-lg  bg-gray-400 transition
