  ...
  return (
    <div className="flex justify-center items-center py-24 ">
      <div className="w-full max-w-xs  p-2 flex flex-col justify-center items-center">
        <h1 className="mb-2 font-bold text-lg tracking-wide">Sign In</h1>
        <button
          className="flex justify-evenly border-slate-400 items-center border m-2 p-2 w-full rounded-full"
        ...
        <button
          className="flex justify-evenly  border-slate-400  items-center border m-2 mb-6 p-2 w-full rounded-full"
